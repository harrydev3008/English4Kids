 ...
 * Use the [ClassicPairsMatchingFragment.newInstance] factory method to
...
class ClassicPairsMatchingFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ClassicPairsMatchingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClassicPairsMatchingFragment().apply {
